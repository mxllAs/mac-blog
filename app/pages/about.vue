    ...
    >
      ...
      <div class="flex flex-col items-center mb-8">
        <div class="relative mb-4">
          ...
          >
            <div
              class="bg-white rounded-full w-full h-full flex items-center justify-center"
            >
          ...
          <div
            class="absolute bottom-0 right-0 w-6 h-6 bg-green-400 rounded-full border-2 border-white"
          ></div>
        </div>
      ...
      <!-- 个人信息卡片 -->
      <div
        class="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-6 mb-8 border border-gray-200/50"
      >
      ...
      <!-- 详细介绍 -->
      <div
        class="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-6 border border-gray-200/50"
      >
        <h2 class="text-xl font-semibold text-gray-800 mb-4 flex items-center">
          <svg
